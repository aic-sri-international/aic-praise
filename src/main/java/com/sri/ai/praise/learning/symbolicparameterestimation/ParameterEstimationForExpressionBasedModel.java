...
public class ParameterEstimationForExpressionBasedModel implements ParameterEstimation {
	...
	public ParameterEstimationForExpressionBasedModel(ExpressionBasedModel model, List<Pair<Expression, Expression>> pairsQueryEvidence) {
		this.model = model;
	...
	/**
	 * Build the map to count the number of similar pairs. 
	 * Allows to not perform the same inference over and over the same query and evidence.
	 *
	 */
