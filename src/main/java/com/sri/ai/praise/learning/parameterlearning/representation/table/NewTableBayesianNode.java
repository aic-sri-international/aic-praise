...
public class NewTableBayesianNode extends TableFactor implements BayesianNode {
	...
	public NewTableBayesianNode(TableVariable child) {
	...
	public NewTableBayesianNode(TableVariable child, ArrayList<TableVariable> parents) {
	...
	public static void main(String[] args) {
	    ...
	    NewTableBayesianNode node = new NewTableBayesianNode(sick, parentsOfSick);
