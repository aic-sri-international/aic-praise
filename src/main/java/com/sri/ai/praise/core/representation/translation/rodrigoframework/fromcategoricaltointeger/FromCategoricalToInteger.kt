                ...
                .forEach { categorical ->
                    categorical.knownConstants.forEach { known ->
                        if (categorical.name == "Boolean") {
                            ...
                            // we assume the target interpreter can manage boolean constants,
                            // because it must surely be able to interpret boolean values anyway.
                            ...
                            // if p then 1 else 0 to if p = 0 then 1 else 0
                            // while at the same time translating
                            // if p = true then 1 else 0 to if p = 0 then 1 else 0
