package com.sri.ai.praise.core.representation.translation.fromrelationaltogroundhogm;
...
//	}
	...
	private String groundFactorIntoItsGroundings(Expression factor, Context context) {
		return explanationBlock("Grounding factor ", factor, code(() -> {
			...
			NonBooleanFactorError.assertExpressionIsValidFactor(factor, context);
