package com.sri.ai.praise.inference.generic.anytime.gabrielstry;
...
import com.sri.ai.praise.inference.generic.representation.expression.ExpressionVariable;
import com.sri.ai.praise.inference.generic.representation.expression.UAIModelToExpressionFactorNetwork;
...
//				Expression entry1 = Expressions.makeSymbol(randomGenerator.nextInt(10000)*1./10000.);
	...
	private static UAIModel retrieveUAIFile(String folderName,String fileName) {
		...
		try {
			...
			UAIEvidenceReader.read(evidenceFIle,model);
