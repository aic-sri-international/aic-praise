...
public class ModelVisitor extends RuleBaseVisitor<Expression> {
	...
	public Expression visitModel(RuleParser.ModelContext ctx) {
		...
		Expression result = Expressions
				.makeFunctionApplication("model", expressions(ctx.elements));
		return result;
	}
	...
	public Expression visitSort_decl(RuleParser.Sort_declContext ctx) {
		...
		Expression result = Expressions.makeFunctionApplication(
	...
	public Expression visitAtomic_rule(RuleParser.Atomic_ruleContext ctx) {
		...
		Expression result = Expressions.makeFunctionApplication(RuleConverter.FUNCTOR_ATOMIC_RULE,
				formula, potential);
	...
	public Expression visitProlog_rule(RuleParser.Prolog_ruleContext ctx) {
		...
		if (rhs != null) {
			result = Expressions.makeFunctionApplication(RuleConverter.FUNCTOR_PROLOG_RULE, potential, head, rhs);
		}
		else {
			result = Expressions.makeFunctionApplication(RuleConverter.FUNCTOR_PROLOG_RULE, potential, head);
		}
		return result;
	}
	...
	public Expression visitProbability_notation_rule(
		...
		Expression result = Expressions.makeFunctionApplication(RuleConverter.FUNCTOR_STANDARD_PROB_RULE, formula1, formula2, potential);
		return result;
	}
	...
	public Expression visitCausal_effect_rule(
		...
		Expression result = Expressions.makeFunctionApplication(RuleConverter.FUNCTOR_CAUSAL_RULE, cause, effect);
		return result;
	}
	...
	public Expression visitConditional_rule(
		...
		Expression result = null;
		if (elseRule != null) {
			result = Expressions.makeFunctionApplication(RuleConverter.FUNCTOR_CONDITIONAL_RULE, condition, thenRule, elseRule);
		}
		else {
			result = Expressions.makeFunctionApplication(RuleConverter.FUNCTOR_CONDITIONAL_RULE, condition, thenRule);
		}
	...
	public Expression visitComplete_atomic_rule(RuleParser.Complete_atomic_ruleContext ctx) {
		...
		Expression result = Expressions.makeFunctionApplication(RuleConverter.FUNCTOR_ATOMIC_RULE, formula, potential);
	...
	public Expression visitFormulaFunctionApplication(
		...
		Expression result = Expressions.makeFunctionApplication(visit(ctx.functor), expressions(ctx.args));
	...
	public Expression visitFormulaNot(RuleParser.FormulaNotContext ctx) {
		Expression result = Expressions.makeFunctionApplication(Not.FUNCTOR, visit(ctx.formula()));
		return result;
	}
	...
	public Expression visitFormulaMayBeSameAs(
		...
		Expression result = Expressions.makeFunctionApplication(RuleConverter.FUNCTOR_MAY_BE_SAME_AS, visit(ctx.leftop), visit(ctx.rightop));
		return result;
	}
	...
	public Expression visitFormulaExponentiation(
		...
		Expression result = Expressions.makeFunctionApplication(FunctorConstants.EXPONENTIATION, visit(ctx.base), visit(ctx.exponent));
		return result;
	}
	...
	public Expression visitFormulaMultiplicationOrDivision(
		...
		Expression result = Expressions.makeFunctionApplication(ctx.op.getText(), visit(ctx.leftop), visit(ctx.rightop));
	...
	public Expression visitFormulaAnd(RuleParser.FormulaAndContext ctx) {
		Expression result = Expressions.makeFunctionApplication(And.FUNCTOR, visit(ctx.leftconj), visit(ctx.rightconj));
		result = possiblyFlatten(result);
		return result;
	}
	...
	public Expression visitFormulaOr(RuleParser.FormulaOrContext ctx) {
		Expression result = Expressions.makeFunctionApplication(Or.FUNCTOR, visit(ctx.leftdisj), visit(ctx.rightdisj));
		result = possiblyFlatten(result);
		return result;
	}
	...
	public Expression visitFormulaImplication(
		...
		Expression result = Expressions.makeFunctionApplication(FunctorConstants.IMPLICATION, visit(ctx.antecedent), visit(ctx.consequent));
		return result;
	}
	...
	public Expression visitFormulaBiconditional(
		...
		Expression result = Expressions.makeFunctionApplication(FunctorConstants.EQUIVALENCE, visit(ctx.leftop), visit(ctx.rightop));
		return result;
	}
	...
	protected Expression possiblyFlatten(Expression expression) {
		...
		if (functor != null) {
			if (functor.equals(FunctorConstants.TIMES) || functor.equals(FunctorConstants.PLUS) || 
				...
				result = Expressions.makeFunctionApplication(functor, args.toArray());
			}
		}
