...
public class LargerProblems extends DefaultConfigurationForTestsOnRandomTableFactorNetworks {

	public LargerProblems(List<Pair<String,BinaryFunction<Variable,FactorNetwork,Factor>>> algorithms) {
		super(
				algorithms,
				/* numberOfRuns = */ 1,
