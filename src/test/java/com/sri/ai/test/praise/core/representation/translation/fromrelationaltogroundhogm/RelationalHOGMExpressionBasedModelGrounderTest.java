...
class RelationalHOGMExpressionBasedModelGrounderTest {
	...
	void test() {
		...
		String actual = RelationalHOGMExpressionBasedModelGrounder.getGroundedModelString(model);
		println(actual);
	...
	void test2() {
		HOGMExpressionBasedModel model = new HOGMExpressionBasedModel(
				""
						...
						"for all Month in 0..5 : "
						+ "if Month < 1 then temp(Month) = Normal(20.0,2.0) else temp(Month) = Normal(temp(Month - 1), 2);"
				);
		...
		String expected = "\n" + 
				...
				"\n" + 
				"temp__0 = Normal(20, 2);\n" + 
				"temp__1 = Normal(temp__0, 2);\n" + 
				"temp__2 = Normal(temp__1, 2);\n" + 
				"temp__3 = Normal(temp__2, 2);\n" + 
				"temp__4 = Normal(temp__3, 2);\n" + 
				"temp__5 = Normal(temp__4, 2);\n" + 
				"";
