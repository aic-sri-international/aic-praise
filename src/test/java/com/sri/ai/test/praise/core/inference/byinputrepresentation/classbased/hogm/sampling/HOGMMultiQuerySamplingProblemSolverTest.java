...
//		Expression expected = parse("if year and (capital = Abyei') then 1 else if year and (capital = Akobo') then 0 else if not year and (capital = Abyei') then 0 else 1");
	...
	@Test
	public void countiesSamplingConditioningSmallTest() {
		...
		String model = "" +
				...
				"x = Normal(0,1);" + 
				"x = 0;" +
				"capital = if x > -1 then Abyei else Akobo;" +
				"";
		
		String query = "capital";
		Expression expected = parse("if capital = Abiemnhom then 0 else if capital = Abyei then 1 else 0");
		int initialNumberOfSamples = 1;
		int numberOfDiscreteValues = 21;
...
//		// warm up
//		runGibbsTest(model, query, expected, initialNumberOfSamples, numberOfDiscreteValues, quantitativeTests, generateGraph, conditioningSample);
...
//		long gibbsInitialTime = System.currentTimeMillis();
//		runGibbsTest(model, query, expected, initialNumberOfSamples, numberOfDiscreteValues, quantitativeTests, generateGraph, conditioningSample);
