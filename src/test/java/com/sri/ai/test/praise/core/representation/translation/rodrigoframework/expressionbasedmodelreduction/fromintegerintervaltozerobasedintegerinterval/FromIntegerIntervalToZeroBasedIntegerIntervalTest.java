...
class FromIntegerIntervalToZeroBasedIntegerIntervalTest {
	...
	void test() {
		...
		FromIntegerIntervalToZeroBasedIntegerInterval translator = new FromIntegerIntervalToZeroBasedIntegerInterval(model);
	...
	private void assertVariableIsDefinedAsIntegerTyped(
			Expression variable,
			FromIntegerIntervalToZeroBasedIntegerInterval translator) {
